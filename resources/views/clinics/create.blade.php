...
@section('title', 'Tambah Klinik - Klinik App')
@section('header_title', 'Tambah Klinik Baru')
    ...
    <form action="{{ route('clinics.store') }}" method="POST" class="space-y-6">
        ...
        <div>
            ...
            <textarea id="description" name="description" rows="4"
                class="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:bg-white focus:ring-2 focus:ring-indigo-100 focus:border-indigo-400 outline-none transition-all">{{ old('description') }}</textarea>
