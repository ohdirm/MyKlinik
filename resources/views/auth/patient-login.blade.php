...
<body class="bg-gradient-to-br from-brand to-brand-dark min-h-screen flex items-center justify-center p-4 font-sans">
    <div class="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full">
        <div class="text-center mb-6">
            ...
            <h1 class="text-2xl font-bold text-gray-900">Masuk ke MyKlinik911</h1>
            <p class="text-sm text-gray-500">Silakan login untuk mengakses semua fitur</p>
        </div>
        ...
        <div class="mt-6 text-center">
            <p class="text-sm text-gray-500">Belum punya akun? <a href="{{ route('register') }}" class="text-brand font-semibold hover:underline">Daftar Sekarang</a></p>
        </div>
