...
@section('content')
<div class="mb-8">
    <h3 class="text-2xl font-bold text-gray-800">Daftar Review</h3>
    <p class="text-sm text-gray-500 mt-1">
        {{ auth()->user()->isAdmin() ? 'Semua ulasan dari pasien.' : 'Ulasan yang pernah Anda berikan.' }}
    </p>
</div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 flex flex-col">
        <div class="flex items-start justify-between mb-4">
            <div>
                ...
                <p class="text-xs text-gray-500">{{ $review->booking->schedule->doctor->clinic->name }}</p>
            </div>
