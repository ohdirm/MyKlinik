...
@section('title', 'Tambah Dokter - Klinik App')
    ...
    <form action="{{ route('doctors.store') }}" method="POST" class="space-y-6">
        ...
        <div>
            ...
            <textarea id="bio" name="bio" rows="4"
                class="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:bg-white focus:ring-2 focus:ring-indigo-100 focus:border-indigo-400 outline-none transition-all">{{ old('bio') }}</textarea>
